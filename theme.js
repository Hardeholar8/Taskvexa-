(function(){
  ...
  function setup(){
    ...
    if(!style){style=document.createElement('style');style.id='taskvexa-theme-style';style.textContent='.taskvexa-theme-button,#themeToggle{position:fixed!important;right:14px!important;bottom:76px!important;width:42px!important;height:42px!important;border-radius:50%!important;border:1px solid #d9e0ea!important;background:#fff!important;color:#111827!important;font-size:19px!important;z-index:2147483647!important;box-shadow:0 6px 18px rgba(0,0,0,.2)!important;cursor:pointer!important}.tvx-light{color-scheme:light}.tvx-light body{background:#f5f7fb!important;color:#111827!important}';document.head.appendChild(style)}
  }
